...
export default async function BlogPostPage({ params }: Props) {
  ...
  return (
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-[1600px] mx-auto px-4 py-24 relative">
        <div className="xl:grid xl:grid-cols-[260px_1fr_280px] xl:gap-12">
          ...
          <article className="max-w-3xl mx-auto xl:mx-0">
            ...
            <div className="xl:hidden my-8 border-2 border-white bg-black shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
