...
const PipelineROIAnalysisGraphic = () => {
  return (
      ...
      <div className="space-y-2.5">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 xl:gap-3 2xl:gap-4">
          <div className="bg-gray-950 rounded-md p-2 xl:p-3 2xl:p-4 border border-gray-800">
            ...
            <div className="text-[9px] xl:text-[10px] 2xl:text-xs text-gray-500 uppercase tracking-wide">Annual Revenue Increase</div>
          </div>
          <div className="bg-gray-950 rounded-md p-2 xl:p-3 2xl:p-4 border border-gray-800">
        ...
        <div className="grid md:grid-cols-2 gap-2 xl:gap-3 2xl:gap-4">
          <div className="bg-gray-950/50 rounded-md p-2.5 xl:p-3 2xl:p-4 border border-gray-800">
            ...
            <div className="space-y-1.5 xl:space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-gray-300 text-[10px] xl:text-xs 2xl:text-sm">Manual Outreach Reduction</span>
                <span className="text-green-400 font-bold text-xs xl:text-sm 2xl:text-base">-65%</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-300 text-[10px] xl:text-xs 2xl:text-sm">Show Up Rate</span>
                <span className="text-green-400 font-bold text-xs xl:text-sm 2xl:text-base">+89%</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-300 text-[10px] xl:text-xs 2xl:text-sm">Interested Replies</span>
          ...
          <div className="bg-gray-950/50 rounded-md p-2.5 xl:p-3 2xl:p-4 border border-gray-800">
            <div className="text-[10px] xl:text-xs 2xl:text-sm text-gray-400 mb-2 uppercase tracking-wide">21-Day Rollout</div>
            <div className="space-y-1.5 xl:space-y-2">
              <div className="flex items-center gap-2">
                <div className="flex-1">
                  <div className="text-[9px] xl:text-[10px] 2xl:text-xs text-gray-500 mb-0.5">Phase 1: Database creation</div>
                ...
                <span className="text-[9px] xl:text-[10px] 2xl:text-xs text-cyan-400 font-bold">7d</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="flex-1">
                  <div className="text-[9px] xl:text-[10px] 2xl:text-xs text-gray-500 mb-0.5">Phase 2: Copywriting and System Building</div>
                  <div className="h-1 xl:h-1.5 2xl:h-2 bg-gray-800 rounded-full overflow-hidden">
                    <div className="h-full bg-purple-500 rounded-full" style={{ width: '100%' }} />
                  </div>
                </div>
                <span className="text-[9px] xl:text-[10px] 2xl:text-xs text-purple-400 font-bold">7d</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="flex-1">
                  <div className="text-[9px] xl:text-[10px] 2xl:text-xs text-gray-500 mb-0.5">Phase 3: CRM , Follow-Up, Reply Flows</div>
                  <div className="h-1 xl:h-1.5 2xl:h-2 bg-gray-800 rounded-full overflow-hidden">
                    <div className="h-full bg-gray-600 rounded-full" style={{ width: '60%' }} />
                  </div>
                </div>
                <span className="text-[9px] xl:text-[10px] 2xl:text-xs text-gray-400 font-bold">7d</span>
              </div>
            </div>
          </div>
        </div>
...
export default PipelineROIAnalysisGraphic;
